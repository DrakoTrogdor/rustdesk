...
// SullTec: extraction dir %LOCALAPPDATA%\SullTecRemote (folder = spaceless app name) —
// never mixes with a stock RustDesk portable's %LOCALAPPDATA%\rustdesk cache.
const APP_PREFIX: &str = "SullTecRemote";
